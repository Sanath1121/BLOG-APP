...
function Register() {
  ...
  const onUserRegister = async (newUser) => {
    ...
    if (!userObj.firstName || !userObj.email || !userObj.password) {
    ...
    try {
      if (role === "user") {
        ...
        let resObj = await axios.post("https://blog-app-1-jrys.onrender.com/user-api/users", formData);
      ...
      if (role === "author") {
        ...
        //make API req to user-api
        let resObj = await axios.post("https://blog-app-1-jrys.onrender.com/author-api/users", formData);
